...
public class RefreshRateSettingsFragment extends DashboardFragment {
    ...
    protected List<AbstractPreferenceController> createPreferenceControllers(Context context) {
        ...
        final MaxRefreshRatePreferenceController maxRefreshRatePreferenceController =
                new MaxRefreshRatePreferenceController(context);
        ...
        controllers.add(maxRefreshRatePreferenceController);
