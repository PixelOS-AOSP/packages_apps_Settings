...
public class BatterySaverRefreshRatePreferenceController extends TogglePreferenceController {
    ...
    public int getAvailabilityStatus() {
        return mContext.getResources().getBoolean(R.bool.config_show_min_refresh_rate_switch) || mContext.getResources().getBoolean(R.bool.config_show_peak_refresh_rate_switch) || mContext.getResources().getBoolean(R.bool.config_show_smooth_display) ? AVAILABLE : UNSUPPORTED_ON_DEVICE;
    }
